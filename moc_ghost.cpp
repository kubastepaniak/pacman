...
QT_MOC_LITERAL(1, 6, 12), // "playerCaught"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 11), // "changeState"
QT_MOC_LITERAL(4, 32, 2) // "go"

    },
    "Ghost\0playerCaught\0\0changeState\0go"
};
...
void Ghost::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Ghost::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Ghost::playerCaught)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject Ghost::staticMetaObject = {
    { &DynamicObject::staticMetaObject, qt_meta_stringdata_Ghost.data,
      qt_meta_data_Ghost,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
