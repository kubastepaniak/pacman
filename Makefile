...
SOURCES       = candy.cpp \
		...
		scene.cpp \
		scoreText.cpp \
		sources/dynamicObject.cpp moc_candy.cpp \
		moc_ghost.cpp \
		moc_greenGhost.cpp \
		moc_player.cpp \
		moc_point.cpp \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents candy.h ghost.h greenGhost.h map.h player.h point.h rect.h redGhost.h scene.h scoreText.h sources/collectable.h sources/dynamicObject.h sources/gameObject.h sources/staticObject.h $(DISTDIR)/
	$(COPY_FILE) --parents candy.cpp ghost.cpp greenGhost.cpp map.cpp pacman.cpp player.cpp point.cpp rect.cpp redGhost.cpp scene.cpp scoreText.cpp sources/dynamicObject.cpp $(DISTDIR)/
...
compiler_rcc_clean:
compiler_moc_header_make_all: moc_candy.cpp moc_ghost.cpp moc_greenGhost.cpp moc_player.cpp moc_point.cpp moc_rect.cpp moc_redGhost.cpp moc_scoreText.cpp moc_collectable.cpp moc_dynamicObject.cpp moc_gameObject.cpp moc_staticObject.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_candy.cpp moc_ghost.cpp moc_greenGhost.cpp moc_player.cpp moc_point.cpp moc_rect.cpp moc_redGhost.cpp moc_scoreText.cpp moc_collectable.cpp moc_dynamicObject.cpp moc_gameObject.cpp moc_staticObject.cpp
...
moc_greenGhost.cpp: ghost.h \
		sources/dynamicObject.h \
		sources/gameObject.h \
		map.h \
		player.h \
		greenGhost.h
	/usr/lib/x86_64-linux-gnu/qt5/bin/moc $(DEFINES) -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64 -I/home/feyron/Desktop/oopc/qt/pacman -I/home/feyron/Desktop/oopc/qt/pacman -I/usr/include/x86_64-linux-gnu/qt5 -I/usr/include/x86_64-linux-gnu/qt5/QtWidgets -I/usr/include/x86_64-linux-gnu/qt5/QtGui -I/usr/include/x86_64-linux-gnu/qt5/QtCore -I/usr/include/c++/5 -I/usr/include/x86_64-linux-gnu/c++/5 -I/usr/include/c++/5/backward -I/usr/lib/gcc/x86_64-linux-gnu/5/include -I/usr/local/include -I/usr/lib/gcc/x86_64-linux-gnu/5/include-fixed -I/usr/include/x86_64-linux-gnu -I/usr/include greenGhost.h -o moc_greenGhost.cpp
...
greenGhost.o: greenGhost.cpp greenGhost.h \
		ghost.h \
		sources/dynamicObject.h \
		sources/gameObject.h \
		map.h \
		player.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o greenGhost.o greenGhost.cpp
...
dynamicObject.o: sources/dynamicObject.cpp sources/dynamicObject.h \
		sources/gameObject.h \
		map.h
...
moc_greenGhost.o: moc_greenGhost.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_greenGhost.o moc_greenGhost.cpp
